...
export default function BadgeEarnedModal({ badge, issuance, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-linear-to-br from-[#0d1a2e] to-[#1a2a3a] border border-indigo-500/30 rounded-3xl p-8 max-w-md w-full text-center space-y-6 shadow-2xl">
        {/* Celebration animation */}
        <div className="text-6xl animate-bounce">🎉</div>

        {/* Badge icon */}
        <div className="flex justify-center">
          <div className="w-32 h-32 rounded-full bg-linear-to-br from-indigo-400 to-purple-600 flex items-center justify-center p-4 shadow-xl shadow-indigo-500/50">
            {badge?.icon ? (
              <div
