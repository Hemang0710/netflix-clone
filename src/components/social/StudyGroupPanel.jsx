        ...
        {groups.length === 0 ? (
          ...
          <div className="space-y-3 max-h-96 overflow-y-auto">
            ...
            <button
              onClick={() => handleAutoJoin(null)}
              disabled={joining}
              className="w-full bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 disabled:from-indigo-900 disabled:to-purple-900 text-white py-2.5 rounded-lg text-sm font-semibold transition-colors"
            >
