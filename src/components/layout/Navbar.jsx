...
export default function Navbar() {
  ...
  const creatorLinks = [
    { href: "/creator", label: "🏠 Creator Hub", description: "All creator tools and features" },
    { href: "/creator/dashboard#analytics", label: "📊 Analytics Hub", description: "Confusion heatmap & dropoff analytics" },
    { href: "/creator/dashboard#ai_tools", label: "✨ AI Tools", description: "Script, thumbnail & course generation" },
  ]
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <div className="relative">
            ...
            >
              🎬 Creator Tools
              <svg
                className={`w-4 h-4 transition-transform ${creatorMenuOpen ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            {creatorMenuOpen && (
              <div className="absolute top-full left-0 mt-1 w-72 glass-card rounded-xl shadow-2xl py-2 border border-indigo-500/15 z-50">
                {creatorLinks.map(({ href, label, description }) => (
                  <Link
                    key={href}
                    href={href}
              ...
              <div className="absolute right-0 top-11 w-52 glass-card rounded-xl shadow-2xl py-1 border border-indigo-500/15">
                ...
                <div className="md:hidden py-1 border-b border-white/5">
                  ...
                  <div className="border-t border-white/5 mt-1 pt-1">
                    <p className="px-4 py-2 text-xs text-slate-500 font-semibold">CREATOR TOOLS</p>
