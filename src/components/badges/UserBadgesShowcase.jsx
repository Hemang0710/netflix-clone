      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
        {badges.map((issuance) => (
          <Link
            ...
            className="group"
          >
            <div className="aspect-square rounded-lg bg-linear-to-br from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 p-3 flex flex-col items-center justify-center cursor-pointer hover:border-indigo-400/60 hover:from-indigo-500/30 hover:to-purple-500/30 transition-all">
              {issuance.badge?.icon ? (
                <div
