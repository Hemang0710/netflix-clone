...
export default function RegisterForm({prefillEmail}) {
  ...
  const [formData, setFormData] = useState({ email: prefillEmail, password: "",confirmPassword:"" })
  ...
  return (
    <div className="relative min-h-screen bg-black flex items-center justify-center"
      style={{
        backgroundImage: "url('https://unsplash.com/photos/a-black-square-with-a-red-n-on-it-sOU09hnONrQ')",
